# Generated by Django 4.0.6 on 2025-01-13 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('onSiteHour', models.TimeField(default=izouapp.models.get_current_time)),
                ('deliveryAdress', models.CharField(blank=True, max_length=50, null=True)),
                ('payment_method_on_site', models.CharField(choices=[('izoua', 'Izoua'), ('delivered_man', 'Livreur')], default='izoua', max_length=50)),
                ('payment_method_order', models.CharField(choices=[('izoua', 'Izoua'), ('delivered_man', 'Livreur')], max_length=50)),
                ('payment_method_delivery', models.CharField(choices=[('izoua', 'Izoua'), ('delivered_man', 'Livreur')], max_length=50)),
                ('create_at', models.DateField(default=django.utils.timezone.now)),
                ('update_at', models.DateField(blank=True, default=django.utils.timezone.now)),
                ('surplace', models.BooleanField(default=False)),
                ('status', models.CharField(choices=[('delivered', 'Livrée'), ('canceled', 'Annulée'), ('on-site', 'Sur place'), ('pending', 'En attente')], default='pending', max_length=50)),
