    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        default="Pizza normale", max_length=50, unique=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("Spéciale", "Spéciale"), ("Normale", "Normale")],
                        default="Normale",
                        max_length=50,
                    ),
                ),
                ...
                (
                    "size",
                    models.CharField(
                        choices=[("Grande", "Grande"), ("Petite", "Petite")],
                        default="Grande",
                        max_length=50,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "onSiteHour",
                    models.TimeField(default=izouapp.models.get_current_time),
                ),
                (
                    "deliveryAdress",
                ...
                (
                    "payment_method_on_site",
                    models.CharField(
                        choices=[("izoua", "Izoua"), ("delivered_man", "Livreur")],
                        default="izoua",
                        max_length=50,
                    ),
                ),
